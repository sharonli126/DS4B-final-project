...
Removing all the NA or weird data
```{r}
primates_filtered <- primates |> 
  filter(!hagrid %in% c("02677", "02675", "02749", "02740", "02790"))

rodentia_filtered <- rodentia|> 
  filter(!hagrid %in% c("02857", "03157", "03192"))

primate_clean <- na.omit(primates_filtered)

rodentia_clean <- na.omit(rodentia_filtered)
```
